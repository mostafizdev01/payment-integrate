...
export declare const PlanScalarFieldEnum: {
    ...
    readonly card_account_holder_name: "card_account_holder_name";
    readonly transition_id: "transition_id";
    readonly payment_methud_type: "payment_methud_type";
};
